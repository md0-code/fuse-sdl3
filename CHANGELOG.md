...
- New cartridge support: the emulator can now detect, insert, and eject Dandanator 512 KB ROM sets, including startup loading and basic bank-switch handling.
...
- File selector enhancements: last used paths are persisted separately across restarts for every file type (allows loading each type of content from a different folder_.
