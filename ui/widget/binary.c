...
ask_filename()
{
  ...
  if( widget_binary.load ) {
    filesel.title = "Fuse SDL3 - Load Binary Data";
    widget_do_fileselector( &filesel );
  } else {
    filesel.title = "Fuse SDL3 - Save Binary Data";
...
menu_file_loadbinarydata( int action )
{
  ...
  widget_binary.filename = ui_get_open_filename( "Fuse SDL3 - Load Binary Data" );
  ...
  widget_binary.title = "Fuse SDL3 - Load Binary Data";
  init_widget_binary();
  /* Run dialog */
  widget_do_binary();
...
menu_file_savebinarydata( int action )
{
  ...
  widget_binary.filename = ui_get_save_filename( "Fuse SDL3 - Save Binary Data" );
  if( !widget_binary.filename ) {
    fuse_emulation_unpause();
    return 1;
  }
  ...
  widget_binary.title = "Fuse SDL3 - Save Binary Data";
  init_widget_binary();
  /* Run dialog */
  widget_do_binary();
